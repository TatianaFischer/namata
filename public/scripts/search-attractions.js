...
function onButtonClick() {
    ...
    L.tileLayer(
        'https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoicGVkcm9wbWFpYSIsImEiOiJja2dhMWEwMTAwMnEzMnNvam1yZGdsdWxkIn0.8gJxjI3utHhuGUcc-yIVKA', {
        maxZoom: 18,
